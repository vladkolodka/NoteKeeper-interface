...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","Окна программы","1. Авторизация","2. Работа с блокнотами","3. Работа с заметками","4. Прикрепить файл","5. Печать","6. Экспорт","7. Импорт","8. Настройки программы","9. Аккаунты","10. О программе","11. Выход из программы","Окно авторизации","Окно MainWindow","Окно Create new note","Окно Create new kachNote account","Окно SettingsWindow","1.1. Вход в свой аккаунт","1.2. Восстановление пароля","1.3. Создание новой учетной записи","2.1. Просмотр блокнотов","2.2. Добавление нового блокнота","2.3. Сокрытие блокнотов","3.1. Создание новой заметки","3.2. Редактирование заметок","3.3. Удаление заметки","3.4. Поиск заметки","3.5. Просмотр информации о заметке","3.6. Просмотр и добавление тегов"],
    DREX_NODE_LINKS: ["index.htm","okna_programmy.htm","avtorizatsiya.htm","rabota_s_bloknotami.htm","rabota_s_zametkami.htm","prikrepit_fajl.htm","pechat.htm","ehksport.htm","import.htm","nastrojki_programmy.htm","akkaunty.htm","o_programme.htm","vykhod_iz_programmy.htm","okno_avtorizatsii.htm","okno_mainwindow.htm","okno_create_new_note.htm","okno_create_new_kachnote_account.htm","okno_settingswindow.htm","vkhod_v_svoj_akkaunt.htm","vosstanovlenie_parolya.htm","sozdanie_novoj_uchetnoj_zapisi.htm","prosmotr_bloknotov.htm","dobavlenie_novogo_bloknota.htm","sokrytie_bloknotov.htm","sozdanie_novoj_zametki.htm","redaktirovanie_zametok.htm","udalenie_zametki.htm","poisk_zametki.htm","prosmotr_informatsii_o_zametke.htm","prosmotr_i_dobavlenie_tegov.htm"],
    DREX_NODE_CHILD_START: [1,13,18,21,24,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30],
    DREX_NODE_CHILD_END: [13,18,21,24,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30],
    DREX_MENU_TYPE: 1,
